  ...
  private async seedLayer4Procurement() {
    ...
    if (!po1) {
      po1 = await poModel.create({
        ...
        status: 'received',
        lines: [
          { sku: 'SKU-001', description: 'Bridal Red Lehenga', recdQty: 10, cost: 25000, selling: 42000, mrp: 45000, taxPercent: 12 },
          { sku: 'SKU-002', description: 'Gold Bridal Lehenga', recdQty: 8, cost: 30000, selling: 50000, mrp: 55000, taxPercent: 12 },
          { sku: 'SKU-003', description: 'Maroon Reception Lehenga', recdQty: 6, cost: 18000, selling: 30000, mrp: 32000, taxPercent: 12 },
        ],
      });
    ...
    if (!po2) {
      po2 = await poModel.create({
        ...
        status: 'received',
        lines: [
          { sku: 'SKU-004', description: 'Kundan Bridal Necklace Set', recdQty: 15, cost: 8000, selling: 14000, mrp: 15000, taxPercent: 3 },
          { sku: 'SKU-005', description: 'Kundan Maang Tikka', recdQty: 20, cost: 3000, selling: 5500, mrp: 6000, taxPercent: 3 },
        ],
      });
