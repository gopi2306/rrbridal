...
const HEADER_ALIASES: Record<string, keyof ParsedProductImportRow> = {
  ...
  colour: 'colourName',
  color: 'colourName',
  colourtypename: 'colourTypeName',
  colortypename: 'colourTypeName',
  'colour type name': 'colourTypeName',
  'color type name': 'colourTypeName',
  'colour type': 'colourTypeName',
  'color type': 'colourTypeName',
  colourtype: 'colourTypeName',
  colortype: 'colourTypeName',
