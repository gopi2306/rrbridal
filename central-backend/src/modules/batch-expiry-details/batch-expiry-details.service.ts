...
import { BatchExpiryDetail, BatchExpiryDetailDocument } from './schemas/batch-expiry-detail.schema';

@Injectable()
export class BatchExpiryDetailsService {
  constructor(@InjectModel(BatchExpiryDetail.name) private readonly model: Model<BatchExpiryDetailDocument>) {}

  async create(dto: CreateBatchExpiryDetailDto) {
  ...
  async update(id: string, dto: UpdateBatchExpiryDetailDto) {
