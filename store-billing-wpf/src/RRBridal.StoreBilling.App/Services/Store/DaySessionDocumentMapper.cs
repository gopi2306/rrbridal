...
internal static class DaySessionDocumentMapper
{
    ...
    public static BsonDocument ToCloseSnapshotDocument(DayBillingCloseSnapshot snap) => new()
    {
        ...
        { "creditCollectionsTotal", (double)snap.CreditCollectionsTotal },
        ...
        { "dispatchChargeCashTotal", (double)snap.DispatchChargeCashTotal },
        { "dispatchChargeCardTotal", (double)snap.DispatchChargeCardTotal },
        { "dispatchChargeUpiTotal", (double)snap.DispatchChargeUpiTotal },
        { "dispatchChargeBankTransferTotal", (double)snap.DispatchChargeBankTransferTotal },
        ...
        { "expenseCashTotal", (double)snap.ExpenseCashTotal },
        { "expenseCardTotal", (double)snap.ExpenseCardTotal },
        { "expenseUpiTotal", (double)snap.ExpenseUpiTotal },
        { "expenseBankTransferTotal", (double)snap.ExpenseBankTransferTotal },
    ...
    private static DayBillingCloseSnapshot ParseCloseSnapshot(BsonDocument doc) => new()
    {
        ...
        CreditCollectionsTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "creditCollectionsTotal"),
        ...
        DispatchChargeCashTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "dispatchChargeCashTotal"),
        DispatchChargeCardTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "dispatchChargeCardTotal"),
        DispatchChargeUpiTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "dispatchChargeUpiTotal"),
        DispatchChargeBankTransferTotal =
            DayBillingCloseDocumentReader.ReadDecimal(doc, "dispatchChargeBankTransferTotal"),
        ...
        ExpenseCashTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "expenseCashTotal"),
        ExpenseCardTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "expenseCardTotal"),
        ExpenseUpiTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "expenseUpiTotal"),
        ExpenseBankTransferTotal = DayBillingCloseDocumentReader.ReadDecimal(doc, "expenseBankTransferTotal"),
