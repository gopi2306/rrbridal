...
public sealed class ProductCatalogService
{
    ...
    private static CatalogProduct? MapFromBson(BsonDocument d, IReadOnlyDictionary<string, string> hsnLookup)
    {
        ...
        return new CatalogProduct
        {
            ...
            MrpWithoutGst = ReadDecimalBson(d, "mrpWithoutGst"),
            SellingPriceWithoutGst = ReadDecimalBson(d, "sellingPriceWithoutGst"),
            StorePriceWithoutGst = ReadDecimalBson(d, "storePriceWithoutGst"),
