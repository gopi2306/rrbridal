...
public static class A5PrePrintedInvoiceLayout
{
    ...
    public const double BodyFontPt = 8.5;
    ...
    public const double BillToLeftMm = 38;
    public const double BillToWidthMm = 30;

    public const double InvNoTopMm = 79;
    ...
    public const double ContactLeftMm = 52;
